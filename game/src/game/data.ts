...
export const FRIENDS: FriendDef[] = [
  ...
  // —— Legendary (minigun beasts: 50 dmg, insanely fast fire) ——
  ...
  { id: "eagle", name: "Bald Eagle", emoji: "🦅", rarity: "legendary", color: "#d0a040", damage: 50, range: 160, attackSpeed: 16, ability: "none" },
