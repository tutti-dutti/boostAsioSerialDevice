...
const BY_ID: Record<string, string[]> = {
  ...
  seal: ["Arf arf!", "Just a seal… trust me!", "Ice to delete you!", "Clap clap clap!", "Secret sauce!", "Oops, 50."],
  ...
  frostseal: ["Deep freeze!", "Arctic clap!", "Snow cone!", "Brrr-illiant!", "Still just a seal!", "OP-erations!"],
